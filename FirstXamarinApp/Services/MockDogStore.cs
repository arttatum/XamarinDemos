    ...
    public class MockDogStore : IDataStore<Dog>
    {
        ...
        public MockDogStore()
        {
            dogs = new List<Dog>()
            {
                ...
                new Dog(){ DogId = Guid.NewGuid().ToString(), Breed = "Border Collie", AverageHeight = 20, AverageWeight = 37, Description = "This highly intelligent, graceful dog is born with an instinct to work and responds extremely well to training, which is why they are often used as a mountain-rescue or sniffer dog. Border Collies make loyal, faithful pets that thrive on company and stimulation."}
            };
        }
